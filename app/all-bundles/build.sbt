...
ocsAppManifest := {
  val bs = List(
    ...
    BundleSpec((sbt.Keys.name in bundle_edu_gemini_seqexec_web_shared).value, Version.parse((sbt.Keys.version in bundle_edu_gemini_seqexec_web_shared).value)),
    BundleSpec((sbt.Keys.name in bundle_edu_gemini_seqexec_web_server).value, Version.parse((sbt.Keys.version in bundle_edu_gemini_seqexec_web_server).value)),
    BundleSpec((sbt.Keys.name in bundle_edu_gemini_seqexec_web_client).value, Version.parse((sbt.Keys.version in bundle_edu_gemini_seqexec_web_client).value)),
