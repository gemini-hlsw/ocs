...
ocsAppManifest := {
  val bs = List(
    ...
    BundleSpec((sbt.Keys.name in bundle_edu_gemini_seqexec_web_server_JVM).value, Version.parse((sbt.Keys.version in bundle_edu_gemini_seqexec_web_server_JVM).value)),
    BundleSpec((sbt.Keys.name in bundle_edu_gemini_seqexec_web_server_JS).value, Version.parse((sbt.Keys.version in bundle_edu_gemini_seqexec_web_server_JS).value)),
