...
/// HACKED VERSION OF JAVA.UTIL.PROPERTIES THAT SUBCLASSES A BETTER MAP THAN HASHTABLE 
...
/** Hacked version of {@linkplain java.util.Properties} that extends {@linkplain LinkedHashMap}. */
@SuppressWarnings({"unchecked", "rawtypes"})
public
class BetterProperties extends LinkedHashMap<String,Object> {
    /**
     ...
     * @serial
     */
    protected BetterProperties defaults;
     ...
     */
    public BetterProperties(BetterProperties defaults) {
