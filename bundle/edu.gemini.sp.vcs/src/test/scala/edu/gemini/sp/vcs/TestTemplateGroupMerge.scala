...
class TestTemplateGroupMerge {
  ...
  implicit def pimpTemplateParameters(tp: ISPTemplateParameters) = new Object {
    ...
    def target = dataObject.getTargetId
  }
  ...
  @Test def testConflictingTemplateGroups() {
    withTestEnv { env =>
      ...
      def targets(tg: ISPTemplateGroup): Set[String] =
        tg.getTemplateParameters.asScala.map(_.target).toSet

      assertEquals(Set("target-4"), targets(tgs(0)))
      assertEquals(Set("target-2", "target-3"), targets(tgs(1)))
      assertEquals(Set("target-0", "target-1"), targets(tgs(2)))
  ...
  val templateFolder = """
        <paramset name="Template Folder" kind="dataObj">
          ...
          <paramset name="phase1Group">
            <param name="blueprint" value="blueprint-0"/>
            <paramset name="templateArgs">
              <param name="target" value="target-4"/>
              <param name="siteQuality" value="condition-0"/>
              <param name="time" value="13824000"/>
            </paramset>
            <paramset name="templateArgs">
              <param name="target" value="target-3"/>
              <param name="siteQuality" value="condition-0"/>
              <param name="time" value="13824000"/>
            </paramset>
            <paramset name="templateArgs">
              <param name="target" value="target-2"/>
              <param name="siteQuality" value="condition-0"/>
            ...
            <paramset name="templateArgs">
              <param name="target" value="target-0"/>
              <param name="siteQuality" value="condition-0"/>
              <param name="time" value="6912000"/>
            </paramset>
          </paramset>
