...
object LibraryStar {
  ...
  case object O9V     extends LibraryStar("O9V", "O9V")
  case object O95V    extends LibraryStar("O9.5V", "O9.5V")
  // B
  case object B0V     extends LibraryStar("B0V", "b0v")
  case object B05V    extends LibraryStar("B0.5V", "B0.5V")
  case object B3V     extends LibraryStar("B3V", "B3V")
  ...
  case object A2V     extends LibraryStar("A2V", "A2V")
  case object A3V     extends LibraryStar("A3V", "A3V")
  case object A4V     extends LibraryStar("A4V", "A4V")
  case object A5V     extends LibraryStar("A5V", "a5v")
  case object A5III   extends LibraryStar("A5III", "a5iii")
  case object A6V     extends LibraryStar("A6V", "A6V")
