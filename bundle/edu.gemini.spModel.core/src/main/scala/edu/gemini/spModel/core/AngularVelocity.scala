...
object RightAscensionAngularVelocity {
  ...
  /**
   * Construct a `RightAscensionAngularVelocity` from the given value in mas/y
   * @group Constructors
   */
  def fromMilliArcSecondsPerYear(mas: Double): RightAscensionAngularVelocity = new RightAscensionAngularVelocity {
    override def toMilliArcSecondsPerYear: Double = mas
  }
}
...
object DeclinationAngularVelocity {
  ...
  /**
   * Construct a `DeclinationAngularVelocity` from the given value in mas/y
   * @group Constructors
   */
