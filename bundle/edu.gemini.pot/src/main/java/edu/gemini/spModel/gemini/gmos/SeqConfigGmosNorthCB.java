...
/**
 * A configuration builder for the GMOS iterator.
 */
public final class SeqConfigGmosNorthCB extends HelperSeqCompCB {
    private static final long serialVersionUID = 1L;

    /**
     * Constructor for creating this seq comp CB.
     */
    public SeqConfigGmosNorthCB(ISPSeqComponent seqComp) {
        super(seqComp);
    }
    ...
    protected void thisApplyNext(IConfig config, IConfig prevFull) {
        ...
        config.putParameter(SeqConfigNames.INSTRUMENT_CONFIG_NAME,
                StringParameter.getInstance(InstConstants.INSTRUMENT_NAME_PROP,
                        InstGmosNorth.INSTRUMENT_NAME_PROP));
