...
//    protected void setTarget(final ITarget target) {
//        _target = target;
//        _notifyOfUpdate();
//    }
//
...
//    }
//
//    public void setSidereal() {
//        if (!(_newTarget instanceof SiderealTarget))
//            setNewTarget(SiderealTarget.empty());
//        _notifyOfUpdate();
//    }
//
//    public void setNonSidereal() {
//        if (!(_newTarget instanceof edu.gemini.spModel.core.NonSiderealTarget))
//            setNewTarget(edu.gemini.spModel.core.NonSiderealTarget.empty());
//        _notifyOfUpdate();
//    }
//
//    public void setTOO() {
//        if (!(_newTarget instanceof TooTarget))
//            setNewTarget(TooTarget.empty());
//        _notifyOfUpdate();
//    }
//
//}
