...
public final class InstNIFS extends SPInstObsComp implements PropertyProvider, GuideProbeProvider, StepCalculator, CalibrationKeyProvider, ConfigPostProcessor, ItcOverheadProvider {
    ...
    public CategorizedTimeGroup calc(final Config cur, final Option<Config> prev) {
        ...
        final CategorizedTime dhs     = CategorizedTime.fromSeconds(Category.DHS_WRITE, 9.8);
    ...
    public double getSetupTime(final Config conf) {
        ...
        if (conf.containsItem(AOConstants.AO_SYSTEM_KEY) && guideStarType.equals(AltairParams.GuideStarType.LGS)) {
