...
public final class SpGmosNBlueprintIfu extends SpGmosNBlueprintSpectroscopyFpuBase {

    public static final String PARAM_SET_NAME = "gmosNBlueprintIfu";

    public SpGmosNBlueprintIfu(SpAltair altair, DisperserNorth disperser, FilterNorth filter, FPUnitNorth fpu) {
        super(altair, disperser, filter, fpu);
    }

    public SpGmosNBlueprintIfu(ParamSet paramSet) {
        super(paramSet);
    }
