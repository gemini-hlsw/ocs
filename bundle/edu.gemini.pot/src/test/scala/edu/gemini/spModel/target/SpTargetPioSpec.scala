...
//
//import edu.gemini.spModel.core.{SiderealTarget, Target, SpectralDistribution, SpatialProfile, Redshift, Arbitraries}
...
//          val spt2 = SPTargetPio.fromParamSet(pset)
//
//          (spt.getNewTarget, spt2.getNewTarget) match {
//            case (t1: SiderealTarget, t2: SiderealTarget) => assert(t1.redshift === t2.redshift)
//            case _                    => assert(false)
//          }
//        }
//      }
