...
public class NavigatorFITSTable extends SkycatTable {
    ...
    // Saved reference to FITS header for the table
     ...
     */
    public NavigatorFITSTable(String filename, Fits fits, TableHDU hdu) throws FitsException {
        _header = hdu.getHeader();
     ...
     *
     * @param filename The name of a FITS file containing a FITS table as the first HDU
     *
     * @return the NavigatorFITSTable object containing the table data
     *
    ...
    /**
     * Look for a skycat catalog configuration entry for this table in another
     * FITS table in the given Fits object with the name "CATINFO".
     *
     * @param fits object to use for FITS I/O
    ...
    /**
     * Save the given table as a binary FITS table in the given Fits object and
     ...
     * @return a NavigatorFITSTable object for the new table
     */
    public static NavigatorFITSTable saveWithImage(String filename, Fits fits, TableQueryResult table)
            throws FitsException, IOException {
