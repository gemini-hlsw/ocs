 ...
 */
public class OIWFS_FeatureTemp extends TpeImageFeature {
    ...
    private static final BasicPropertyList _props = new BasicPropertyList(OIWFS_FeatureTemp.class.getName());
     ...
     */
    public OIWFS_FeatureTemp() {
        super("OIWFS (2)", "Show the field of view of the OIWFS (if any).");
    }
