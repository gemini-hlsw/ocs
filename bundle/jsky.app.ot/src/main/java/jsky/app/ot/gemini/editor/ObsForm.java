...
//        row += 2;
	...
	JPanel tooCardPanel;
    SingleSelectComboBox phase2StatusBox;
    JPanel execStatusPanel;
	DropDownListBoxWidget qaStateBox;
	JCheckBox override;
	JLabel qaStateSum;
	JLabel dataflowStep;
	JLabel obsClass;
	...
	DropDownListBoxWidget timeCorrectionOp;
	NumberBoxWidget timeCorrection;
	SingleSelectComboBox timeCorrectionUnits;
	JLabel correctionToFromLabel;
	SingleSelectComboBox chargeClass;
