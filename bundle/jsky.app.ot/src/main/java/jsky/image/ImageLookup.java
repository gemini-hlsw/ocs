 ...
 * ESO Archive
 *
 * $Id: ImageLookup.java 4414 2004-02-03 16:21:36Z brighton $
 *
 * who             when        what
 * --------------  ----------  ----------------------------------------
...
public class ImageLookup {
     ...
     * if needed.  To apply the lookup table to the image, you can use
    ...
    public PlanarImage histEqScale(PlanarImage im, double lowCut, double highCut,
        ...
        int binWidth = (scaledHighCut - scaledLowCut) / numBins;
        if (binWidth == 0)
            binWidth = 1;
        int maxCount = 0;
        int totalCount = 0;
