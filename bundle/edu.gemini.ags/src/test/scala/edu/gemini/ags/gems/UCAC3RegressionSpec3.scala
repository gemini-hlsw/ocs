...
class UCAC3RegressionSpec3 extends Specification with UCAC3Regression {
  ...
  val tipTiltCriterion = GemsCatalogSearchCriterion(GemsCatalogSearchKey(GemsGuideStarType.tiptilt, Canopus.Wfs.Group.instance), CatalogSearchCriterion("Canopus Wave Front Sensor", RadiusConstraint.between(Angle.zero, Angle.fromArcmin(1.0)), MagnitudeConstraints(MagnitudeBand.R, FirstBandExtractor(RLikeBands), FaintnessConstraint(15.0), Some(SaturationConstraint(7.5))), Some(Offset(5.394250.arcsecs[OffsetP], 5.394250.arcsecs[OffsetQ])), None))
  ...
  val flexureCriterion = GemsCatalogSearchCriterion(GemsCatalogSearchKey(GemsGuideStarType.flexure, GsaoiOdgw.Group.instance), CatalogSearchCriterion("On-detector Guide Window", RadiusConstraint.between(Angle.zero, Angle.fromArcmin(1.0)), MagnitudeConstraints(MagnitudeBand.H, FaintnessConstraint(17.0), Some(SaturationConstraint(8.0))), Some(Offset(OffsetP(Angle.fromDegrees(5.394250)), OffsetQ(Angle.fromDegrees(5.394250)))), None))
