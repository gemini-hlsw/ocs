...
class UCAC3RegressionSpec3 extends Specification with UCAC3Regression {
  ...
  val tipTiltCriterion = GemsCatalogSearchCriterion(GemsCatalogSearchKey(GemsGuideStarType.tiptilt, Canopus.Wfs.Group.instance), CatalogSearchCriterion("Canopus Wave Front Sensor", List(MagnitudeBand.R), MagnitudeRange(FaintnessConstraint(15.0), Some(SaturationConstraint(7.5))), RadiusConstraint.between(Angle.zero, Angle.fromArcmin(1.0)), Some(Offset(5.394250.arcsecs[OffsetP], 5.394250.arcsecs[OffsetQ])), None))
  ...
  val flexureCriterion = GemsCatalogSearchCriterion(GemsCatalogSearchKey(GemsGuideStarType.flexure, GsaoiOdgw.Group.instance), CatalogSearchCriterion("On-detector Guide Window", List(MagnitudeBand.H), MagnitudeRange(FaintnessConstraint(17.0), Some(SaturationConstraint(8.0))), RadiusConstraint.between(Angle.zero, Angle.fromArcmin(1.0)), Some(Offset(OffsetP(Angle.fromDegrees(5.394250)), OffsetQ(Angle.fromDegrees(5.394250)))), None))
