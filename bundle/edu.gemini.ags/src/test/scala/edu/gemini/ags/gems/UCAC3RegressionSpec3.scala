...
class UCAC3RegressionSpec3 extends Specification with UCAC3Regression {
  ...
  val tipTiltTargets = List(
    SiderealTarget("042-030622", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:23.888").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:18.2").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(15.787, MagnitudeBand.J),new Magnitude(15.156, MagnitudeBand.K),new Magnitude(15.114, MagnitudeBand.H),new Magnitude(14.273, MagnitudeBand.R))),
    SiderealTarget("042-030635", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:24.997").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:04.77").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(15.71, MagnitudeBand.J),new Magnitude(14.602, MagnitudeBand.K),new Magnitude(14.589, MagnitudeBand.H),new Magnitude(14.721, MagnitudeBand.R))),
    SiderealTarget("042-030696", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.179").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:09.21").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.673, MagnitudeBand.J),new Magnitude(14.834, MagnitudeBand.K),new Magnitude(14.539, MagnitudeBand.H),new Magnitude(17.103, MagnitudeBand.B),new Magnitude(14.977, MagnitudeBand.R),new Magnitude(14.403, MagnitudeBand.I))),
    SiderealTarget("042-030698", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.405").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:24.08").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.428, MagnitudeBand.J),new Magnitude(13.691, MagnitudeBand.K),new Magnitude(14.29, MagnitudeBand.H),new Magnitude(18.086, MagnitudeBand.B),new Magnitude(14.249, MagnitudeBand.R),new Magnitude(14.632, MagnitudeBand.I))),
    SiderealTarget("042-030696", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.179").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:09.21").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.673, MagnitudeBand.J),new Magnitude(14.834, MagnitudeBand.K),new Magnitude(14.539, MagnitudeBand.H),new Magnitude(17.103, MagnitudeBand.B),new Magnitude(14.977, MagnitudeBand.R),new Magnitude(14.403, MagnitudeBand.I))),
    SiderealTarget("042-030698", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.405").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:24.08").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.428, MagnitudeBand.J),new Magnitude(13.691, MagnitudeBand.K),new Magnitude(14.29, MagnitudeBand.H),new Magnitude(18.086, MagnitudeBand.B),new Magnitude(14.249, MagnitudeBand.R),new Magnitude(14.632, MagnitudeBand.I))))
  ...
  val flexureTargets = List(
    ...
    SiderealTarget("042-030696", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.179").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:09.21").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.673, MagnitudeBand.J),new Magnitude(14.834, MagnitudeBand.K),new Magnitude(14.539, MagnitudeBand.H),new Magnitude(17.103, MagnitudeBand.B),new Magnitude(14.977, MagnitudeBand.R),new Magnitude(14.403, MagnitudeBand.I))),
    SiderealTarget("042-030698", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.405").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:24.08").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.428, MagnitudeBand.J),new Magnitude(13.691, MagnitudeBand.K),new Magnitude(14.29, MagnitudeBand.H),new Magnitude(18.086, MagnitudeBand.B),new Magnitude(14.249, MagnitudeBand.R),new Magnitude(14.632, MagnitudeBand.I))),
    SiderealTarget("042-030626", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:24.59").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:56.27").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(15.578, MagnitudeBand.J),new Magnitude(15.095, MagnitudeBand.K),new Magnitude(15.089, MagnitudeBand.H),new Magnitude(18.729, MagnitudeBand.B),new Magnitude(16.806, MagnitudeBand.R),new Magnitude(15.382, MagnitudeBand.I))),
    SiderealTarget("042-030669", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:30.429").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:18.68").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(16.322, MagnitudeBand.J),new Magnitude(16.721, MagnitudeBand.K),new Magnitude(15.804, MagnitudeBand.H),new Magnitude(18.65, MagnitudeBand.B),new Magnitude(16.314, MagnitudeBand.R),new Magnitude(15.653, MagnitudeBand.I))),
    SiderealTarget("042-030678", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:32.629").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:15:48.64").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(13.801, MagnitudeBand.J),new Magnitude(13.414, MagnitudeBand.K),new Magnitude(13.459, MagnitudeBand.H),new Magnitude(18.186, MagnitudeBand.B),new Magnitude(15.455, MagnitudeBand.R),new Magnitude(14.221, MagnitudeBand.I))),
    SiderealTarget("042-030696", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.179").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:09.21").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.673, MagnitudeBand.J),new Magnitude(14.834, MagnitudeBand.K),new Magnitude(14.539, MagnitudeBand.H),new Magnitude(17.103, MagnitudeBand.B),new Magnitude(14.977, MagnitudeBand.R),new Magnitude(14.403, MagnitudeBand.I))),
    SiderealTarget("042-030698", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:36.405").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:16:24.08").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.428, MagnitudeBand.J),new Magnitude(13.691, MagnitudeBand.K),new Magnitude(14.29, MagnitudeBand.H),new Magnitude(18.086, MagnitudeBand.B),new Magnitude(14.249, MagnitudeBand.R),new Magnitude(14.632, MagnitudeBand.I))),
    SiderealTarget("042-030702", Coordinates(RightAscension.fromAngle(Angle.parseHMS("5:35:38.009").getOrElse(Angle.zero)), Declination.fromAngle(Angle.parseDMS("-69:15:47.48").getOrElse(Angle.zero)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(16.205, MagnitudeBand.J),new Magnitude(15.558, MagnitudeBand.K),new Magnitude(15.887, MagnitudeBand.H),new Magnitude(18.36, MagnitudeBand.B),new Magnitude(15.88, MagnitudeBand.R),new Magnitude(15.425, MagnitudeBand.I))))
  ...
  val mascotStars = List(
    Star(SiderealTarget("042-030698",Coordinates(RightAscension.fromAngle(Angle.fromDegrees(83.90168749999998)),Declination.fromAngle(Angle.fromDegrees(290.72664444444445)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.428,MagnitudeBand.J), new Magnitude(13.691,MagnitudeBand.K), new Magnitude(14.29,MagnitudeBand.H), new Magnitude(18.086,MagnitudeBand.B), new Magnitude(14.249,MagnitudeBand.R), new Magnitude(14.632,MagnitudeBand.I))),-44.51300737797379,-13.009999999962929,2.0,14.249),
    Star(SiderealTarget("042-030622",Coordinates(RightAscension.fromAngle(Angle.fromDegrees(83.84953333333334)),Declination.fromAngle(Angle.fromDegrees(290.72827777777775)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(15.787,MagnitudeBand.J), new Magnitude(15.156,MagnitudeBand.K), new Magnitude(15.114,MagnitudeBand.H), new Magnitude(14.273,MagnitudeBand.R))),21.936983034367834,-7.130000000074688,2.0,14.273),
    Star(SiderealTarget("042-030635",Coordinates(RightAscension.fromAngle(Angle.fromDegrees(83.85415416666666)),Declination.fromAngle(Angle.fromDegrees(290.73200833333334)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(15.71,MagnitudeBand.J), new Magnitude(14.602,MagnitudeBand.K), new Magnitude(14.589,MagnitudeBand.H), new Magnitude(14.721,MagnitudeBand.R))),16.052010976423862,6.300000000055661,2.0,14.721),
    Star(SiderealTarget("042-030696",Coordinates(RightAscension.fromAngle(Angle.fromDegrees(83.9007458333333)),Declination.fromAngle(Angle.fromDegrees(290.730775)).getOrElse(Declination.zero)), None, None, None, List(new Magnitude(14.673,MagnitudeBand.J), new Magnitude(14.834,MagnitudeBand.K), new Magnitude(14.539,MagnitudeBand.H), new Magnitude(17.103,MagnitudeBand.B), new Magnitude(14.977,MagnitudeBand.R), new Magnitude(14.403,MagnitudeBand.I))),-43.32150491056957,1.8600000000105865,2.0,14.977)
  )
