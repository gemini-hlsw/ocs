...
class MascotGuideStarSpec extends Specification {
  ...
  val loadedTargets = List(
    ...
    SiderealTarget("-282565385", Coordinates(RightAscension.fromAngle(Angle.fromDegrees(49.97353900000002)), Declination.fromAngle(Angle.fromDegrees(41.51455199999998)).getOrElse(Declination.zero)), Some(ProperMotion(RightAscensionAngularVelocity(AngularVelocity(1.7053025658242404E-13)), DeclinationAngularVelocity(AngularVelocity(359.99999999999994)), Epoch(2000.0), None, None)), List(Magnitude(16.02, MagnitudeBand.B, None, MagnitudeSystem.VEGA), Magnitude(14.212, MagnitudeBand.H, Some(0.047), MagnitudeSystem.VEGA), Magnitude(15.16, MagnitudeBand.I, None, MagnitudeSystem.VEGA), Magnitude(14.666, MagnitudeBand.J, Some(0.032), MagnitudeSystem.VEGA), Magnitude(14.21, MagnitudeBand.K, Some(0.065), MagnitudeSystem.VEGA), Magnitude(15.1, MagnitudeBand.R, None, MagnitudeSystem.VEGA)), None),
  ...
  "Mascot" should {
    ...
    "find best asterism by query result" in {
      ...
      val query = CatalogQuery.catalogQuery(coordinates, RadiusConstraint.between(Angle.fromArcmin(MascotCat.defaultMinRadius), Angle.fromArcmin(MascotCat.defaultMaxRadius)), ppmxl)
