...
class GemsGuideSearchOptionsSpec extends Specification {
  ...
  "GemsGuideSearchOptions" should {
    "provide search options for gsaoi in instrument tip tilt mode" in {
      ...
      criteria(1).criterion.magConstraint should beEqualTo(MagnitudeConstraints(RBandsList, FaintnessConstraint(16.0), Some(SaturationConstraint(8.5))))
    }
    "provide search options for gsaoi in canopus tip tilt mode" in {
      ...
      criteria.head.criterion.magConstraint should beEqualTo(MagnitudeConstraints(RBandsList, FaintnessConstraint(16.0), Some(SaturationConstraint(8.5))))
    ...
    "provide search options for gsaoi in both tip tilt modes" in {
      ...
      criteria(3).criterion.magConstraint should beEqualTo(MagnitudeConstraints(RBandsList, FaintnessConstraint(16.0), Some(SaturationConstraint(8.5))))
    }
  }
}
