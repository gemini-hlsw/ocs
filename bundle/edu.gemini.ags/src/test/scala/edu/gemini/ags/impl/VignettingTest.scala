...
class VignettingTest {
  ...
  @Test def testSideLookingOneOffsetPosAngle0() = {
    ...
    executeTest(expected, offsets = List(Offset(Angle.fromArcsecs(50.0), Angle.fromArcsecs(50.0))))
  }
  ...
  @Test def testSideLookingOneOffset2PosAngle0() = {
    ...
    val expected = List(GS7, GS6)
    executeTest(expected, offsets = List(Offset(Angle.fromArcsecs(200.0), Angle.fromArcsecs(50.0))))
  }
