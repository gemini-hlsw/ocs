...
import edu.gemini.spModel.core.{Declination, Angle, MagnitudeBand, Site}
 ...
 * See OT-27
 */
class GemsCatalogResultsSpec extends MascotProgress with Specification {
  ...
  def search(inst: SPInstObsComp, raStr: String, decStr: String, tipTiltMode: GemsTipTiltMode): List[GemsGuideStars] = {
    ...
    val results = new GemsCatalog().search(obsContext, GemsUtils4Java.toCoordinates(base), options, None.instance[MagnitudeBand], null)
