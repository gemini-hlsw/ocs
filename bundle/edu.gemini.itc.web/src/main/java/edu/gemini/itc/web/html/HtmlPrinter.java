...
public final class HtmlPrinter {
        ...
        switch (sdp.getDistributionType()) {
            case ELINE:
                ...
                sb.append(String.format(
                        ...
                        sdp.getELineWidth().toKilometersPerSecond(), sdp.getELineFlux().toWattsPerSquareMeter(), sdp.getELineContinuumFlux().toWatts()));
                break;
            case BBODY:
    ...
    public static String printParameterSummary(final PlottingDetails pdp) {
        ...
        switch (pdp.getPlotLimits()) {
            ...
            case USER: sb.append("plotted over range " + pdp.getPlotWaveL()*1000 + " - " + pdp.getPlotWaveU()*1000);
