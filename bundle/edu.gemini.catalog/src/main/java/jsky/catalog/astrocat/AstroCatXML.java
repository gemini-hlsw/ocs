...
public final class AstroCatXML extends SaxParserUtil {
        ...
        for (int i = n - 1; i >= 0; i--) {
            ...
            if (c instanceof AstroCatalog) {
                ...
                if (path == null || path.length() == 0) {
                    Catalog cat = CatalogRegistry.instance.lookup(catalog.getName());
                    if (cat == null) {
            ...
            if (_catalog.getName() == null) {
                ...
                if (Catalog.DIRECTORY.equals(_catalog.getType())) {
                    ...
                    try {
                        ...
                        System.out.println("Warning: error loading catalog directory: "
                                + _catalog.getName() + ": " + e);
                    }
                } else {
    ...
    private static void _saveCatalog(XMLWriter xml, Catalog catalog) throws SAXException {
        ...
        if (catalog instanceof AstroCatalog) {
            ...
            String urlPath = cat.getOrigPath();
            if (urlPath == null) {
                // This may be the case if the catalog was not accessed (details were not read from xml file)
    ...
    public InputSource resolveEntity(String publicId, String systemId) {
        return new InputSource(getClass().getResourceAsStream("/resources/AstroCat.dtd"));
    }
