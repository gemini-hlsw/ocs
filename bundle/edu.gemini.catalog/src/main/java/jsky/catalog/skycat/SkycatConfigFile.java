...
public class SkycatConfigFile extends AbstractCatalogDirectory {
    ...
    private void _load() {
        ...
        try {
            ...
            if (protocol.equals("file") || protocol.equals("jar") || protocol.equals("bundle")) {
    ...
    public List<Catalog> getNameServers() {
        List<Catalog> l = CatalogRegistry.instance.getCatalogsByType(Catalog.NAME_SERVER);
    ...
    private void _addDefaultNameServers() {
        ...
        CatalogRegistry.instance.register(cat, false);
    ...
    public void save(OutputStream stream) {
        ...
        for (int i = 0; i < numCatalogs; i++) {
            out.println();
            SkycatCatalog catalog = (SkycatCatalog) catalogs.get(i); // Unsafe cast
