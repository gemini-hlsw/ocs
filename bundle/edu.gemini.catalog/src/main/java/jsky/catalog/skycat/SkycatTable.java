 ...
 * a JTable widget.
 *
 * @version $Revision: 23751 $ $Date: 2010-02-08 11:13:56 -0800 (Mon, 08 Feb 2010) $
...
public class SkycatTable extends MemoryCatalog {
    ...
    public SkycatTable(SkycatCatalog catalog, InputStream in, int maxRows) throws IOException {
        super(catalog, in,
                catalog == null ? None.INSTANCE :
                SkycatOutputAdapterFactoryRegistrar.instance.lookup(catalog.getId()), maxRows);
