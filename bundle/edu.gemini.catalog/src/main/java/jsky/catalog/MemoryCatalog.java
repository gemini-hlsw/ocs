...
public class MemoryCatalog extends DefaultTableModel
    ...
    protected SkycatOutputAdapter getAdapter(BufferedReader rdr) {
        return new DefaultOutputAdapter(rdr);
    }
    ...
    public void setColumnClasses(List l) {
        _columnClasses = l;
    }
