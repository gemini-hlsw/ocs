...
abstract class SimpleListViewer[A, B, C <: Object](implicit ev: Null <:< B, ev2: Null <:< C)
  extends ScrollPane
  with Bound[A, B] {
  ...
  protected object viewer extends GTableViewer[B, C, Column](controller) with SingleSelectViewerHelpers[C] {
