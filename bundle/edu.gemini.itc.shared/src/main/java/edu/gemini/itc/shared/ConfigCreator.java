...
public class ConfigCreator {
    ...
    private static final double GSAOI_SMALL_SKY_OFFSET = 120.0; // arcsec (assumed in case of sky offset <5')
    private static final double GSAOI_LARGE_SKY_OFFSET = 310.0; // arcsec (assumed in case of sky offset >5')
    ...
    private ConfigCreatorResult createCommonConfig(int numberExposures) {
