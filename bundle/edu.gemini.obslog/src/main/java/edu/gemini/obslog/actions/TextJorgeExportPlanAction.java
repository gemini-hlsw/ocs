...
import edu.gemini.obslog.TextExport.TextJorgeObslogExporter;
...
public class TextJorgeExportPlanAction extends OlBaseAction {
    private static final Logger LOG = Logger.getLogger(TextJorgeExportPlanAction.class.getName());
    ...
    public String execute() {
        ...
        TextJorgeObslogExporter exp = new TextJorgeObslogExporter(observingLog, _options, planID);
        String result;
        try {
            result = exp.export();
        } catch (OlLogException ex) {
