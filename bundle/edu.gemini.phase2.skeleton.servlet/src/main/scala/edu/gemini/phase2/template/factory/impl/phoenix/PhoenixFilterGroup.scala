...
object PhoenixFilterGroup {
  ...
  def forFilter(f: PhoenixParams.Filter): PhoenixFilterGroup = {
    ...
    f match {
      case J7799 | J8265 | J9232 | J9440 | J9671 |
           H6073 | H6420 |
           K4132 | K4220 | K4308 | K4396 | K4484 |  K4578 | K4667 | K4748 => JHK
      case L2462 | L2734 | L2870 | L3010 | L3100 | L3290 => L
      case M1930 | M2030 | M2150 => M
    }
  }
