 ...
 */
public class GnirsSouth extends Gnirs {
    ...
    public GnirsSouth(GnirsParameters gp, ObservationDetailsParameters odp) throws Exception {
        ...
        double HIGH_READ_NOISE_VALUE = 147;
        double MEDIUM_READ_NOISE_VALUE = 38;
        double LOW_READ_NOISE_VALUE = 12;
        double VERY_LOW_READ_NOISE_VALUE = 7;
