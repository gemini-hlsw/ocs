...
public final class AltairParameters extends ITCParameters {
    ...
    public void parseServletRequest(HttpServletRequest r) throws Exception {
        ...
        if (_guideStarSeperation<0||_guideStarSeperation>22) throw new Exception(" Altair Guide star distance must be between 0 and 22");
        ...
        if (_guideStarMagnitude>17||_guideStarMagnitude<7) throw new Exception(" Altair Guide star Magnitude must be between 7 and 17 ");
...
//       }
	...
	if (_wfs.equals(AOWFS))
        ...
        if (_guideStarSeperation<0||_guideStarSeperation>25) throw new Exception(" Altair Guide star distance must be between 0 and 25 arcsecs.");

        if (_wfsMode.equals(LGS)&&_guideStarMagnitude>19.5) throw new Exception(" Altair Guide star Magnitude must be <= 19.5 in R for LGS mode. ");

	 if (_wfsMode.equals(NGS)&&_guideStarMagnitude>15.5) throw new Exception(" Altair Guide star Magnitude must be <= 15.5 in R for NGS mode. ");
    ...
    public boolean altairIsUsed() { return _altairUsed;}
    public double getGuideStarSeperation() { return _guideStarSeperation; }
    public double getGuideStarMagnitude() { return _guideStarMagnitude;}
    public String getWFSMode() { return _wfsMode;}
