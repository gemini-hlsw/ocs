 ...
 */
public final class ITCMichelleServlet
        extends ITCServlet {
    ...
    public void writeOutput(HttpServletRequest r, PrintWriter out)
        ...
        if (r.getContentType().startsWith("multipart/form-data")) {
            recipe = new MichelleRecipe(new ITCMultiPartParser(r, MAX_CONTENT_LENGTH), out);
        } else
            recipe = new MichelleRecipe(r, out); // parses form data
