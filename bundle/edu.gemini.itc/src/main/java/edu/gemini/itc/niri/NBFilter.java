...
//
// $Id: NBFilter.java,v 1.2 2003/11/21 14:31:02 shane Exp $
//
...
/**
 * Narrow Band Filter
 * This class exists so that the client can specify a NB filter number
 * instead of specifying the data file name specifically.
 */
@Deprecated
public class NBFilter extends TransmissionElement {
     ...
     * </ul>
     */
    public NBFilter(String nbFilter, String dir) throws Exception {
        super(dir + FILENAME + nbFilter + Instrument.getSuffix());
        _File = dir + FILENAME + nbFilter + Instrument.getSuffix();
