...
object UpConverter {
  ...
  val from2017A:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2017, SemesterOption.A)))
  val from2016B:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2016, SemesterOption.B)))
  val from2016A:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2016ATo2016B, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2016, SemesterOption.A)))
  val from2015B:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2016ATo2016B, SemesterConverter2015BTo2016A, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2015, SemesterOption.B)))
  val from2015A:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2016ATo2016B, SemesterConverter2015BTo2016A, SemesterConverter2015ATo2015B, SemesterConverter2017ATo2017B,   LastStepConverter(Semester(2015, SemesterOption.A)))
  val from2014B:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2016ATo2016B, SemesterConverter2015ATo2015B, SemesterConverter2014BTo2015A, SemesterConverter2014BTo2014BSV, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2014, SemesterOption.B)))
  val from2014A:List[SemesterConverter] = List(SemesterConverterToCurrent, SemesterConverter2016BTo2017A, SemesterConverter2016ATo2016B, SemesterConverter2015ATo2015B, SemesterConverter2014BTo2015A, SemesterConverter2014BTo2014BSV, SemesterConverter2014ATo2014B, SemesterConverter2017ATo2017B, LastStepConverter(Semester(2014, SemesterOption.A)))
